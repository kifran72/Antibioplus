    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="container">
                ...
                <div class="container">
                    <form class="form" method="post" action="">
                        <div class="form-group container-fluid ">
                            ...
                            <div class="col-sm-2">
                                <label for="date-begin">Date de fin</label>
                                <input type="text" name="date-begin" class="form-control" id="date-begin" placeholder="JJ/MM/AAAA">
                            </div>
                        </div>
                        <div class="form-group container-fluid ">
                        ...
                        <div class="form-group container-fluid ">
                            <div class="col-sm-8">
                                <label for="nommol">Equipe</label>
                                <select name="nommol" id="nommol" class="selectpicker">
                                    <?php
                                        $etude = new etude;

                                        $list_equipe = $etude->getEquipe();

                                        $etude->fillInput($list_equipe, "Nom_Equipe");
                                    ?>
                                </select>
                            </div>
                        </div>
                ...
                <div class="form-group container-fluid">
                    <input type="submit" class="btn btn-success" value="Créer l'étude">
                </div>
            </div>
